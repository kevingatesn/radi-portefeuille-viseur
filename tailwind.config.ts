		...
		extend: {
			...
			colors: {
				...
				'solar-orange': {
					...
					light: 'hsl(var(--solar-orange-light))',
					dark: 'hsl(var(--solar-orange-dark))',
				},
				'vibrant-violet': {
					DEFAULT: 'hsl(var(--vibrant-violet))',
					light: 'hsl(var(--vibrant-violet-light))',
					dark: 'hsl(var(--vibrant-violet-dark))',
				},
